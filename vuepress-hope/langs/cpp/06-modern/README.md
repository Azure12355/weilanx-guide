...
<VPCard
  title="现代 C++ 入门"
  desc="C++11/14/17/20 核心特性总览：auto、Lambda、智能指针、移动语义"
  logo="https://api.iconify.design/ri/star-line.svg"
...
1. **C++11 基础**：auto、Lambda、智能指针
2. **移动语义**：理解右值引用和 std::move
3. **C++14/17**：泛型 Lambda、结构化绑定
4. **C++20**：Concepts、Ranges
5. **最佳实践**：现代 C++ 风格指南
